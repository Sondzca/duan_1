                        ...
                        <div class="row">
                            <div class="panel panel-primary col-md-6">
                                ...
                                <div class="form-gruop">
                                    <label for="">Phương thức thanh toán: &emsp;  </label> <br>
                                    <input type="radio" class="" id="tienmat" name="payment" >Thanh Toán Khi Nhận Hàng
                                    <br>
                                     <input type="radio" class="" id="online" name="payment"> Thanh Toán online
                                     <br>
                            ...
                            <div class="panel panel-primary col-md-6">
                                ...
                                <a href="dashboard.php"><button class="btn btn-success">Đặt hàng</button></a> <br> <br>   
