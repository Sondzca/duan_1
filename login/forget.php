...
<body>
    <div id="wrapper">
        <header>
            <div class="container">
                <section class="logo">
                    <a href="../index.php"><img src="../images/tealogo.png" alt=""></a>
                </section>
                <nav>
                    <ul>
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            try {
                ...
                $nguoigui = 'xuanquynhkmt@gmail.com'; // Tài khoản Email
                $matkhau = 'Son162004@'; // Mật khẩu Email
                $mail->SMTPSecure = 'ssl';
                $mail->Port = 465;  // Port kết nối: khai báo 465 hoặc 587                
                var_dump($mail);

                // Recipients - Người nhận
                $tennguoigui = 'Phạm Quang Thọ'; // Tên người gửi lấy từ form nhập
                $mail->Username = $nguoigui; // SMTP username
                $mail->Password = $matkhau;   // SMTP password
                $mail->setFrom($nguoigui, $tennguoigui); //mail và tên người nhận 
                $to = $email; // Email cần gửi đến lấy từ form nhập
                $to_name = "Phạm Quang Thọ"; // Tên người cần gửi đến
